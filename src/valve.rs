...
impl<T: Pin> Valve<T> {
    ...
    pub fn new(pin: Output<'static, T>) -> Self {
        Self {
            pin
        }
    }
...
pub(crate) struct ValveControler {
...
impl ValveControler {
    ...
    pub fn new(mut valve1: Valve<embassy_rp::peripherals::PIN_12>,
           mut valve2: Valve<embassy_rp::peripherals::PIN_13>,
           mut valve3: Valve<embassy_rp::peripherals::PIN_14>,
           mut valve4: Valve<embassy_rp::peripherals::PIN_15>) -> Self {
        valve1.close();
        valve2.close();
        valve3.close();
        valve4.close();
